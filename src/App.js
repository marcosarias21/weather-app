...
function App() {
  const { list, cityName, places, clima } = useContext(weatherContext);
  ...
  const cityClima = useFetch(
    `http://api.weatherapi.com/v1/forecast.json?key=6be8c28794924ed8a2a184922222905&q=${clima}&days=1&aqi=no&alerts=no`,
  );
